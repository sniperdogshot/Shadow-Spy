...
document.getElementById('login-form').addEventListener('submit', function(event) {
    ...
    // Simples validação (substitua isso por uma validação real)
...
function mostrarTiro() {
    var numeroAleatorio = Math.floor(Math.random() * 82) + 1;
    let mensagens = {
...
function mostrarBomba() {
    ...
    let mensagemAleatoria = mensagens[numeroAleatorio] || "Mensagem padrão para outros números.";
    document.getElementById('S').innerHTML = `<br>${mensagemAleatoria}`;
